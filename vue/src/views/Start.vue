...
<template>
    ...
    <Content>
        ...
        I navigationen til venstre finder du 5 faner foruden denne startside.
        <br>
        <br>
    ...
    <Content>
        <template>
            Kontakt evt. FOBI-udvikler Christian Skermer Leonhardt på csl@randers.dk for hjælp med at komme igang.
        </template>
    </Content>
