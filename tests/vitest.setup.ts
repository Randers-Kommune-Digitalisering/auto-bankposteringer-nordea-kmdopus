...
setIfMissing('ERP_PRIMARY_ACCOUNT_LABEL', 'Artskonto')
setIfMissing('ERP_SECONDARY_ACCOUNT_LABEL', 'Omkostningssted')
setIfMissing('ERP_TERTIARY_ACCOUNT_LABEL', 'PSP-element')

setIfMissing('SFTP_URL', 'sftp://example.invalid')
setIfMissing('SFTP_USERNAME', 'dummy')
setIfMissing('SFTP_PASSWORD', 'dummy')
setIfMissing('SFTP_SEND_DIR', '/data/output/')
setIfMissing('SFTP_RECEIVE_DIR', '/fra-randers/')
